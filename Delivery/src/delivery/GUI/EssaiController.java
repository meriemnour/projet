...
public class EssaiController implements Initializable {
            ...
            if(us.approvedlogin(tfusername.getText(),pfpassword.getText())){
              ...
              try {
                        ...
                        Logger.getLogger(LoginFormController.class.getName()).log(Level.SEVERE, null, ex);
                         ...
                         try {
                        Parent root=FXMLLoader.load(getClass().getResource("/delivery/GUI/VehiculeDocument.fxml"));
                        Scene scene = new Scene(root);
                        // aandi interface 9dima w bech n7el interface jdida w nsaker l 9dima donc nestaamel node
                        Stage stage=(Stage)((Node) event.getSource()).getScene().getWindow();
                    ...
                    System.out.println("interface collaborateur");
                        ...
                        Parent root=FXMLLoader.load(getClass().getResource("/delivery/GUI/FXMLDocument.fxml"));
                        Scene scene = new Scene(root);
                        // aandi interface 9dima w bech n7el interface jdida w nsaker l 9dima donc nestaamel node
                        Stage stage=(Stage)((Node) event.getSource()).getScene().getWindow();
                        stage.setTitle("Livreur9");
                        stage.setScene(scene);
                        stage.show();
                    } catch (IOException ex) {
                        Logger.getLogger(LoginFormController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void signin(ActionEvent event) {
        ...
        if(errors.length()>0){
            ...
            m.SendMail(u.getEmail(), "Bienvenue", "Sign in");
            SmsApi s=new SmsApi();
            //  s.sendSMS("+21652778549","bienvenue");
            s.sendSMS("+216"+String.valueOf(u.getNumTel()), "bienvenue");
            Alert alert=new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information");
