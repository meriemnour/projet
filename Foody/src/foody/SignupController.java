...
public class SignupController implements Initializable {
   public SignupModel signupModel= new SignupModel();
    ...
    @FXML
    private JFXTextField textusern;
   ...
   private void exitScreen(ActionEvent event){
    ...
    public void Signup(ActionEvent event){
        ...
        String username=textusern.getText().toLowerCase();
        String landmark=textland.getText().toLowerCase();
        String  dp = dpdate.getValue().toString();

        
       try {
           if((fname.isEmpty()|| lname.isEmpty() || email.isEmpty() || pass.isEmpty() || phone.isEmpty()  || landmark.isEmpty() || username.isEmpty() || dp.isEmpty() )){
              alertLabel.setText("Please fill blank fields");
               ...
               alertLabel.setText("");
               signupModel.isSignup(fname, lname, email, pass, phone, username, landmark, dp); 
